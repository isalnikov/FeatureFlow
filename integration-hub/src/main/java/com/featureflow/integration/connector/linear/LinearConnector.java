package com.featureflow.integration.connector.linear;
...
@Component
public class LinearConnector implements TaskTrackerConnector {

    private static final String SOURCE_TYPE = "linear";

    private final WebClient.Builder webClientBuilder;

    public LinearConnector(WebClient.Builder webClientBuilder) {
